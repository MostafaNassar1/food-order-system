    ...
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            <?php
                ...
                //Count the row to check wether we have food data or not
                ...
                if($count>0)
                    {
                    ...
                    else
                        {
                            ...
                            echo "<tr><td colspan='7' class='error'>Food Not Added Yet.</td></tr>";//Written html code inside php or we can do it out of php
                        }
