                            ...
                            if($count>0)
                                {
                                    ...
                                    while($row=mysqli_fetch_assoc($res))
                                    {
                                       ...
                                       // echo "<option value='$category_id'>$category_title</option>"; First Way
                                        //Second Way
                                        ?>
                                    ...
                                    if($upload==false)
                                        {
                                            ...
                                            header('location:'.SITEURL.'admin/manage-food.php');
                                            //Stop the process
                                            die();//to update the data in database
                                        }
                                        ...
                                        if($current_image!="")
                                            {
                                                ...
                                                $remove = unlink($remove_path);//Remove the image from our given path
                                                //Check wether the image is removed or not
                                                if($remove==false)
                                                    {
                                                        //Failed to remove current image
                                                        $_SESSION['remove-failed'] = "<div class='error'>Failed to Remove Currnet Image</div>";
                                                        header('location:'.SITEURL.'admin/manage-form.php');
                                                        die();
                                                    }
                                            }
                                }
